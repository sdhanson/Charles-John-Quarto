    ...
    async.parallel([
            ...
            function(callback) {
                collectionCreate('WHEN MY SISTER FELL OUT OF THE MAPLE TREE', 'Present', 'Charles John Quarto', ['TAKING UP THE FIDDLE',
                    ...
                    'NIGHT IS',
                    'THE ATTIC MASTER',
                    'THE SIGNAL WAS EARLY',
                    'IF THE MUSIC',
                    'IN MRS. KAISERS\' SEVENTH GRADE MATH CLASS',
                    'THE NIGHT TIME',
                    'HAWK',
                    'WITH OLD COWBOYS',
                    'WHEN I SEE THE WIND HELPING THE ROBINS',
                    'GHOST OF MY GUITAR',
                    'DEBUT OF A ROSE',
                    'DARE OF AN ANGEL',
                    'CHILDREN DANCING IN A RING',
                    'OBSERVATIONS FROM CENTERPOINT HILL',
                    'CHURCHBELLS',
